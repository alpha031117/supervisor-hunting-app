    ...
    <script>
            ...
            function updateData(semester = '') {
                ...
                fetch('/filter-lecturer-quota', {
                    ...
                    .then((data) => {
                        ...
                        updateTable(data.lecturers);
                    })
                    .catch((error) => {
                        console.error('Error fetching data:', error);
                        tableBody.innerHTML = `
                            <tr>
                                <td colspan="6" class="text-center text-red-500">An error occurred. Please try again.</td>
                            </tr>
                        `;
                    });
            }
        ...
        generateReportBtn.addEventListener('click', async () => {
            try {
                ...
                const response = await fetch('/filter-lecturer-quota', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': csrfToken,
