...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto dark:bg-gray-800">
        ...
        <ul class="space-y-2 font-medium mt-10">
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2 ml-1">
                <li>
                    <a href="{{ route('set-timeframe') }}"
                        class="flex items-center w-full p-2 text-gray-500 transition duration-75 rounded-lg pl-11 group hover:text-gray-900 dark:text-white dark:hover:bg-gray-700">Set
                        Timeframe</a>
                </li>
                <li>
                    <a href="{{ route('edit-timeframe') }}"
                        class="flex items-center w-full p-2 text-gray-500 transition duration-75 rounded-lg pl-11 group hover:text-gray-900 dark:text-white dark:hover:bg-gray-700">Edit
                        Timeframe</a>
                </li>
            </ul>
            <li>
