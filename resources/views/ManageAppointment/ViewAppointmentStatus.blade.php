...
<div id="reminderModal" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6 relative">
        ...
        <!-- Close Icon -->
        <button onclick="closeReminderModal()" 
            class="absolute top-2 right-2 text-gray-500 hover:text-gray-600">
...
@endif
    <!-- Success Message -->
    @if (session('message'))
        <div class="bg-green-100 border border-green-300 text-green-600 px-4 py-3 rounded-lg text-center shadow-md mb-6">
