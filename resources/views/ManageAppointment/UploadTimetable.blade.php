...
<div class="container mx-auto py-10">
    ...
    <div class="text-center mb-10">
        <h1 class="text-4xl font-extrabold text-blue-600">Welcome, {{ auth()->user()->name }}!</h1>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white shadow-lg rounded-lg p-8">
                ...
                <div class="text-center mb-6">
                    <h3 class="text-2xl font-semibold text-blue-600">Upload Your Timetable</h3>
                ...
                <!-- Timetable Upload -->
                <div class="mb-6">
                    <label for="schedule" class="block text-lg font-bold mb-2 text-blue-600">Upload Your Timetable</label>
                    ...
                    <div class="mt-4 relative">
                        <label class="flex flex-col items-center justify-center w-full h-20 bg-blue-50 border-2 border-dashed border-blue-600 rounded-lg cursor-pointer hover:bg-blue-100">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        fileInput.addEventListener('change', function () {
            ...
            if (file) {
                ...
                fileNameElement.classList.add('text-gray-600', 'font-semibold', 'mt-2');
